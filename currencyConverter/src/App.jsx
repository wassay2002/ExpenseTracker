...
function App() {
  ...
  return (
    <div className="w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat" style={{
      backgroundImage: `url('https://softileo.com/media/images/posts/blog-9.jpg')`,
    }}>
                            ...
                            >
                              <div className="w-full mb-1">
                                <Input 
                                  ...
                                  onCurrencyChange={(currency) => setAmount(currency)} // Corrected syntax
                                ...
                                <button type="submit"
                                  className="w-full bg-blue-600 text-white x-4 y-3 rounded-lg "
                                  >
